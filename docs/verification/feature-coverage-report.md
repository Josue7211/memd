...
| `feature.external_replay_auditor_proof` | `partial` | `strong` | `none` | `planned` | Strong local auditor-readiness proof validates schema/registry wiring, instructions, checksums/immutability, registered public-smoke artifact schema, and fresh temp public-smoke generation; no independent external replay artifact is registered. |
