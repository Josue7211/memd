...
| `feature.product_ux_dashboard_cli_language` | `partial` | `strong` | `none` | `none` | Strong local proof validates CLI help/descriptions, setup/getting-started docs, dashboard source/routes/components, unsupported-claim guard, and dashboard static build; no real browser walkthrough/dogfood/external validation is registered. |
