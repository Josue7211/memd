...
| `feature.dogfood_reliability_windows` | `partial` | `strong` | `ad_hoc` | `none` | Strong local proof inventories dated evidence and finds zero sustained windows under the no-false-positive rule; dogfood remains ad_hoc. |
