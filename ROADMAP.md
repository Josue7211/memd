...
version: v20
version_status: evidence_ops_active_runtime_authority_complete
current_milestone: V20
milestone_status: evidence_ops_active_runtime_authority_complete
current_phase: V20-evidence-ops
phase_status: runtime_authority_complete_real_evidence_pending
next_milestone: V20
...
last_handoff: docs/handoff/2026-05-09-runtime-authority-complete.md
...
- version status: `evidence_ops_active_runtime_authority_complete`
...
- next step: execute evidence ops from `docs/verification/release-1-0-0/2026-05-06-evidence-ops-start.md`; first weekly review note due 2026-05-13; do not cut `1.0.0` until real-user, elapsed-window, external-auditor, and third-party replay artifacts exist.
...
| K3 | Proxy Unblock + Canonical Rerun | `pending` | provision gpt-4o on openclaw LiteLLM proxy (or OpenAI-direct fallback with `MEMD_BENCH_JUDGE_BUDGET_USD=50`), rerun LongMemEval/LoCoMo/ConvoMem canonical primaries, flip rows verified/recorded-unpinned per J3 verdict logic. Gate unblocks V3 completion contract. | [[docs/backlog/v3/2026-04-23-gpt5.4-proxy-route-for-judge.md]] |
