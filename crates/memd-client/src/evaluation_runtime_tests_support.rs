    ...
    #[test]
    pub(super) fn derives_assignment_message_from_assign_scope() {
    ...
    #[test]
    pub(super) fn resolves_nested_bundle_rag_config() {
    ...
    #[test]
    pub(super) fn resolves_legacy_bundle_rag_url() {
        let config = BundleConfigFile {
            project: None,
            namespace: None,
            agent: None,
    ...
    #[test]
    pub(super) fn serializes_bundle_config_with_nested_rag_state() {
    ...
    #[test]
    pub(super) fn writes_bundle_memory_placeholder_with_hot_path_guidance() {
        let dir =
    ...
    #[test]
    pub(super) fn wake_fallback_writes_placeholder_memory_and_wakeup_files() {
    ...
    #[test]
    pub(super) fn checkpoint_fallback_writes_placeholder_memory_without_agent() {
        let dir =
    ...
    #[test]
    pub(super) fn fallback_memory_and_wakeup_surfaces_include_authority_warning() {
        let dir =
...
"#,
    ...
    #[test]
    pub(super) fn copies_hook_assets_with_live_capture_scripts() {
    ...
    #[test]
    pub(super) fn writes_command_catalog_markdown_into_bundle_root() {
    ...
    #[test]
    pub(super) fn codex_pack_manifest_exposes_recall_capture_cache_and_files() {
        let bundle_root =
    ...
    #[test]
    pub(super) fn claude_code_pack_manifest_exposes_native_bridge_and_files() {
    ...
    #[test]
    pub(super) fn command_catalog_includes_slash_and_skill_commands() {
        let bundle_root = std::env::temp_dir().join(format!(
    ...
    #[test]
    pub(super) fn openclaw_pack_manifest_exposes_context_spill_cache_and_files() {
        let bundle_root =
    ...
    #[test]
    pub(super) fn harness_registry_exposes_shared_preset_ids_and_defaults() {
    ...
    #[tokio::test]
    pub(super) async fn codex_pack_refreshes_wakeup_and_memory_files_after_capture() {
        let bundle_root =
    ...
    #[tokio::test]
    pub(super) async fn openclaw_pack_refreshes_wakeup_and_memory_files_after_capture() {
        let bundle_root =
    ...
    #[tokio::test]
    pub(super) async fn hermes_pack_refreshes_wakeup_and_memory_files_after_capture() {
        let bundle_root =
    ...
    #[test]
    pub(super) fn harness_pack_turn_key_is_stable_for_repeated_recall() {
    ...
    #[test]
    pub(super) fn codex_pack_backend_failure_falls_back_to_local_bundle_truth() {
        let bundle_root =
    ...
    #[test]
    pub(super) fn codex_pack_docs_cover_operational_flow_and_fallback() {
    ...
    #[test]
    pub(super) fn init_bootstrap_summarizes_existing_project_files() {
        let project_root =
    ...
    #[test]
    pub(super) fn init_bootstrap_writes_source_registry() {
        let project_root =
    ...
    #[test]
    pub(super) fn refresh_bootstrap_memory_detects_changed_source() {
        let project_root =
    ...
    #[test]
    pub(super) fn capability_registry_detects_bridgeable_superpowers_plugin() {
...
"#,
    ...
    #[test]
    pub(super) fn capability_registry_collects_harness_surface_artifacts() {
        let _home_lock = lock_home_mutation();
...
"#,
    ...
    #[test]
    pub(super) fn capability_registry_collects_openclaw_and_opencode_artifacts() {
        let _home_lock = lock_home_mutation();
        let home = std::env::temp_dir().join(format!(
    ...
    #[test]
    pub(super) fn capability_bridges_install_superpowers_into_agents_skills() {
        let _home_lock = lock_home_mutation();
...
"#,
    ...
    #[test]
    pub(super) fn capability_bridge_inspection_reports_available_without_mutating_targets() {
        let _home_lock = lock_home_mutation();
    ...
    #[test]
    pub(super) fn capability_bridges_install_superpowers_into_opencode_plugin_roots() {
        let _home_lock = lock_home_mutation();
        let home =
...
"#,
    ...
    #[test]
    pub(super) fn render_capability_registry_summary_includes_claude_family_bridgeable_records() {
    ...
    #[test]
    pub(super) fn render_capability_bridge_summary_includes_opencode_targets() {
        let home =
    ...
    #[test]
    pub(super) fn detect_claude_family_harness_roots_finds_clawcode_shape() {
        let home =
    ...
    #[test]
    pub(super) fn capability_registry_detects_claude_family_fork_plugin_state() {
        let _home_lock = lock_home_mutation();
...
"#,
    ...
    #[test]
    pub(super) fn init_output_prefers_project_root_when_seeded_from_repo() {
        let project_root =
    ...
    #[test]
    pub(super) fn init_output_prefers_global_bundle_when_requested() {
        let project_root =
