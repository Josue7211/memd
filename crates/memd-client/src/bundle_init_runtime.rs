...
pub(crate) fn effective_hive_groups(hive_groups: Vec<String>, project: Option<&str>) -> Vec<String> {
...
pub(crate) fn collect_skill_capabilities(records: &mut Vec<CapabilityRecord>, harness: &str, root: &Path) {
