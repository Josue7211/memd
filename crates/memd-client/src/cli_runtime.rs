...
pub(crate) async fn run_cli(cli: Cli) -> anyhow::Result<()> {
    ...
    match cli.command {
        ...
        Commands::Wake(args) => {
            bundle_turn_runtime::run_bundle_wake_command(&args, &base_url).await?;
        }
        ...
        Commands::Setup(args) => {
            bundle_admin_runtime::run_bundle_setup_command(&args).await?;
        }
        Commands::Doctor(args) => {
            bundle_admin_runtime::run_bundle_doctor_command(&args, &base_url).await?;
        }
        Commands::Config(args) => {
            bundle_admin_runtime::run_bundle_config_command(&args, &base_url).await?;
        }
        ...
        Commands::Init(args) => {
            bundle_admin_runtime::run_bundle_init_command(args).await?;
        }
        Commands::Loops(args) => {
