...
#[path = "obsidian_parsing.rs"]
mod obsidian_parsing;
use obsidian_parsing::{
    fallback_attachment_match, parse_attachment_from_raw, parse_markdown_note,
    parse_markdown_note_from_raw,
};
use crate::obsidian_support::{
    attachment_matches_scope, classify_asset_kind, default_scan_cache_path,
    default_sync_state_path, hash_bytes, hash_content, is_text_like_attachment,
    note_matches_scope, should_skip_vault_path, system_time_to_utc,
};
