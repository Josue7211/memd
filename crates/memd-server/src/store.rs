...
#[path = "store_hive_runtime.rs"]
mod store_hive_runtime;
#[path = "store_memory_domains.rs"]
mod store_memory_domains;
#[path = "store_memory_runtime.rs"]
mod store_memory_runtime;
