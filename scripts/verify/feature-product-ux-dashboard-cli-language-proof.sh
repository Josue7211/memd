...
for text in   "not a browser walkthrough"   "No real browser session"   "Forbidden claim"   'external_status`: none'   "setup/getting-started"; do
...
for term in ["local", "docs", "cli", "dashboard source", "setup"]:
